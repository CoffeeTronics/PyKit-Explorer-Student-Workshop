...
The default `code.py` is a **unified game launcher** that automatically discovers and cycles through games in the `/games/` folder. Pull pin D11 LOW at any time to switch to the next game.

### Included Games

| Game                   | Description                                                      | Controls                                                 | Lives |
| ---------------------- | ---------------------------------------------------------------- | -------------------------------------------------------- | ----- |
| **Snake**        | Classic snake game — eat food to grow, avoid walls and yourself | Tilt board to change direction, CAP1 to toggle demo mode | 3     |
| **Space Impact** | Side-scrolling space shooter with enemies, bosses, and power-ups | Tilt to move ship, D3 to fire, CAP1 for special weapon   | 3     |
| **Super Mario**  | Platformer — jump on enemies, collect coins, reach the flag     | Tilt to move, D3 to jump, CAP1 to run                    | 3     |
...
3. **Gameplay** — Play until game over or press D11 to switch
...
#### Splash Screens (`/Sprites/`)

| File                 | Game         | Format                 |
| -------------------- | ------------ | ---------------------- |
| `snake_splash.bmp` | Snake        | 240x135, 4-bit indexed |
| `SI_splash.bmp`    | Space Impact | 240x135, 8-bit indexed |
| `mario_splash.bmp` | Super Mario  | 240x135, 8-bit indexed |

#### Game Over Screens (`/Sprites/`)

| File                    | Game         | Format                         |
| ----------------------- | ------------ | ------------------------------ |
| `Game_Over_Snake.bmp` | Snake        | 240x135, 4-bit indexed (~16KB) |
| `Game_Over_SI.bmp`    | Space Impact | 240x135, 4-bit indexed (~16KB) |
| `Game_Over_SMB.bmp`   | Super Mario  | 240x135, 4-bit indexed (~16KB) |

#### Audio Files (`/AudioFiles/`)

| File                    | Used By      | Description                   |
| ----------------------- | ------------ | ----------------------------- |
| `210.wav`             | Snake        | Food eaten sound              |
| `140.wav`             | Snake        | Game over sound               |
| `si_shoot.wav`        | Space Impact | Firing sound                  |
| `si_explosion.wav`    | Space Impact | Enemy/player explosion        |
| `gameover_man.wav`    | Space Impact | Game over ("Game over, man!") |
| `smb_jump.wav`        | Mario        | Jump sound                    |
| `smb_coin.wav`        | Mario        | Coin collected                |
| `smb_gameover.wav`    | Mario        | Game over music               |
| `smb_world_clear.wav` | Mario        | Level complete fanfare        |
